...
\begin{solution}
	...
	\begin{step}
		Prove $a, b \in \mathbb{F}[x]_n \implies a + B \mathbb{F}[x]_n$.
	\end{step}
...
\begin{solution}
	%TODO: Email TA about this
	$b = 0, 1, 2$ 

	$p = a_0 + a_1x + \ldots + a_n{x^n}, a_i \in {0, 1, 2}$.
	$\forall g \in \mathcal{P}(F_3), \forall b \in {0, 1, 2}$.
	$g(b) = p(b) \coloneq a_0 + a_1(b) + \ldots (a_n)(b)^n$.
\end{solution}
